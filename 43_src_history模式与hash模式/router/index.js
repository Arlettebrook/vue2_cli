...
const router = new VueRouter({
    // router的工作模式：默认hash，还有history
    // hash=# hash值，#后面的内容，这些内容不会传递给服务器
    // hash模式会显示#，改为history，不会显示#
    // 所以hash兼容性好,history刷新之后会出问题：hash值会传递给服务器

    // history解决办法：利用backend的一些库如connect-history-api-fallback
    mode:'history',
    // 路由规则：
    routes:[
        {
            ...
            children:[
                {
                    ...
                    //     console.log('@独享路由守卫只有前置：',to,from)
